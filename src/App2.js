        ...
        <div style={{ display: "flex", height: "100vh", width: "100%", background: "#1c1f26", fontFamily: "Inter, system-ui, sans-serif", color: "#e5e7eb" }}>
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ height: 56, background: "#181b21", borderBottom: "1px solid #262a33", display: "flex", alignItems: "center", padding: "0 16px", gap: 10 }}>
                    <strong style={{ fontSize: 14, letterSpacing: 0.3, marginRight: 8 }}>Snap&nbsp;Edit</strong>
                ...
                {/* Canvas area */}
                <div style={{ flex: 1, overflow: "auto", display: "flex", alignItems: "flex-start", justifyContent: "center", padding: 32, background: "#1c1f26" }}>
                    {!bgImage && (
                        <div style={{ position: "absolute", color: "#6b7280", fontSize: 14, marginTop: 240, textAlign: "center" }}>
            ...
            {/* Right inspector */}
            <div style={{ width: 220, background: "#14161b", borderLeft: "1px solid #262a33", padding: 16, fontSize: 13 }}>
